...
const login = defaultRequire("sagor-fca");
...
let subTitle = `SaGor Bot V2@${currentVersion}- A simple Bot chat messenger use personal account`;
const subTitleArray = [];
...
const modified = ("Modified by jahidul");
const fbUrl = ("Facebook: https://facebook.com/SAGOR.69x");
...
async function startBot(loginWithEmail) {
        ...
        (function loginBot(appState) {
                ...
                login({ appState }, global.GoatBot.config.optionsFca, async function (error, api) {
                        ...
                        console.log(`\x1b[1m\x1b[33m${("COPYRIGHT:")}\x1b[0m\x1b[1m\x1b[37m \x1b[0m\x1b[1m\x1b[36m${("Project GoatBot v2 created by SaGor, you are using SaGor bot Thank you!")}\x1b[0m`);
                        logColor("#f5ab00", character);
